...
<head>
	...
	<title>PLN</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/iconpln.jpg" type="image/x-icon">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/orang.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
